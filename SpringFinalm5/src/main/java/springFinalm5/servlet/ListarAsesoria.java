...
public class ListarAsesoria extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		AsesoriasDAOImpl asDAO = new AsesoriasDAOImpl();
		List<Asesoria> aSS = asDAO.readAll();
		request.setAttribute("ass", aSS);
		getServletContext().getRequestDispatcher("/ShowAsesoria.jsp").forward(request, response);
	}
